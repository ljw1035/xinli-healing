        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2.5">
              {/* 工具0：自评温度计 */}
              <div 
                className="p-3 bg-purple-50/40 dark:bg-purple-950/20 hover:bg-purple-100/60 dark:hover:bg-purple-900/30 rounded-xl border border-purple-100/50 dark:border-purple-800/40 transition-all cursor-pointer active:scale-[0.98]"
              ...
              >
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-[10px] text-purple-500 bg-purple-100/60 dark:bg-purple-900/40 px-1.5 py-0.2 rounded font-semibold">量化评估</span>
                </div>
                <p className="text-[11px] text-slate-500 dark:text-slate-300 leading-normal">
              ...
              {/* 工具1：呼吸放松 */}
              <div 
                className="p-3 bg-blue-50/50 dark:bg-blue-950/20 hover:bg-blue-100/60 dark:hover:bg-blue-900/30 rounded-xl border border-blue-100/50 dark:border-blue-800/40 transition-all cursor-pointer active:scale-[0.98]"
              ...
              >
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-[10px] text-blue-500 bg-blue-100/60 dark:bg-blue-900/40 px-1.5 py-0.2 rounded font-semibold">生理调节</span>
                </div>
                <p className="text-[11px] text-slate-500 dark:text-slate-300 leading-normal">
                  关键字：<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-blue-100 dark:border-blue-800 rounded text-blue-700 font-semibold">呼吸</code>、<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-blue-100 dark:border-blue-800 rounded text-blue-700 font-semibold">手抖</code>、<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-blue-100 dark:border-blue-800 rounded text-blue-700 font-semibold">紧张</code>、<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-blue-100 dark:border-blue-800 rounded text-blue-700 font-semibold">失眠</code>。
                </p>
              </div>

              {/* 工具2：GAD-7 */}
              <div 
                className="p-3 bg-amber-50/40 dark:bg-amber-950/20 hover:bg-amber-100/60 dark:hover:bg-amber-900/30 rounded-xl border border-amber-100/50 dark:border-amber-800/40 transition-all cursor-pointer active:scale-[0.98]"
              ...
              >
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-[10px] text-amber-500 bg-amber-100/60 dark:bg-amber-900/40 px-1.5 py-0.2 rounded font-semibold">标准化筛查</span>
                </div>
                <p className="text-[11px] text-slate-500 dark:text-slate-300 leading-normal">
                  关键字：<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-amber-100 dark:border-amber-800 rounded text-amber-700 font-semibold">焦虑</code>、<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-amber-100 dark:border-amber-800 rounded text-amber-700 font-semibold">担心</code>、<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-amber-100 dark:border-amber-800 rounded text-amber-700 font-semibold">不安</code>。7题标准化量表，0-21分×4等级，非医学诊断。
                </p>
              </div>

              {/* 工具3：ACT */}
              <div 
                className="p-3 bg-teal-50/40 dark:bg-teal-950/20 hover:bg-teal-100/60 dark:hover:bg-teal-900/30 rounded-xl border border-teal-100/50 dark:border-teal-800/40 transition-all cursor-pointer active:scale-[0.98]"
              ...
              >
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-[10px] text-teal-500 bg-teal-100/60 dark:bg-teal-900/40 px-1.5 py-0.2 rounded font-semibold">接纳承诺</span>
                </div>
                <p className="text-[11px] text-slate-500 dark:text-slate-300 leading-normal">
                  关键字：<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-teal-100 dark:border-teal-800 rounded text-teal-700 font-semibold">内耗</code>、<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-teal-100 dark:border-teal-800 rounded text-teal-700 font-semibold">迷茫</code>、<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-teal-100 dark:border-teal-800 rounded text-teal-700 font-semibold">自责</code>。
                </p>
              </div>

              {/* 工具4：CBT */}
              <div 
                className="p-3 bg-violet-50/40 dark:bg-violet-950/20 hover:bg-violet-100/60 dark:hover:bg-violet-900/30 rounded-xl border border-violet-100/50 dark:border-violet-800/40 transition-all cursor-pointer active:scale-[0.98]"
              ...
              >
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-[10px] text-violet-500 bg-violet-100/60 dark:bg-violet-900/40 px-1.5 py-0.2 rounded font-semibold">想法检验</span>
                </div>
                <p className="text-[11px] text-slate-500 dark:text-slate-300 leading-normal">
                  关键字：<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-violet-100 dark:border-violet-800 rounded text-violet-700 font-semibold">想太多</code>、<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-violet-100 dark:border-violet-800 rounded text-violet-700 font-semibold">我不行</code>、<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-violet-100 dark:border-violet-800 rounded text-violet-700 font-semibold">都是我的错</code>、<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-violet-100 dark:border-violet-800 rounded text-violet-700 font-semibold">万一</code>。识别认知偏差→收集证据→建立平衡想法。
                </p>
              </div>

              {/* 工具5：SFBT */}
              <div 
                className="p-3 bg-sky-50/40 dark:bg-sky-950/20 hover:bg-sky-100/60 dark:hover:bg-sky-900/30 rounded-xl border border-sky-100/50 dark:border-sky-800/40 transition-all cursor-pointer active:scale-[0.98]"
              ...
              >
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-[10px] text-sky-500 bg-sky-100/60 dark:bg-sky-900/40 px-1.5 py-0.2 rounded font-semibold">资源建构</span>
                </div>
                <p className="text-[11px] text-slate-500 dark:text-slate-300 leading-normal">
                  关键字：<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-sky-100 dark:border-sky-800 rounded text-sky-700 font-semibold">总是失败</code>、<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-sky-100 dark:border-sky-800 rounded text-sky-700 font-semibold">拖延</code>、<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-sky-100 dark:border-sky-800 rounded text-sky-700 font-semibold">没希望</code>。
                </p>
              </div>

              {/* 工具6：情绪日记 */}
              <div 
                className="p-3 bg-rose-50/40 dark:bg-rose-950/20 hover:bg-rose-100/60 dark:hover:bg-rose-900/30 rounded-xl border border-rose-100/50 dark:border-rose-800/40 transition-all cursor-pointer active:scale-[0.98]"
              ...
              >
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-[10px] text-rose-500 bg-rose-100/60 dark:bg-rose-900/40 px-1.5 py-0.2 rounded font-semibold">日常记录</span>
                </div>
                <p className="text-[11px] text-slate-500 dark:text-slate-300 leading-normal">
                  关键字：<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-rose-100 dark:border-rose-800 rounded text-rose-700 font-semibold">写日记</code>、<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-rose-100 dark:border-rose-800 rounded text-rose-700 font-semibold">记录心情</code>、<code className="bg-white dark:bg-slate-800 px-1.5 py-0.5 border border-rose-100 dark:border-rose-800 rounded text-rose-700 font-semibold">总结一天</code>。记录情绪标签、强度、触发事件、身体感受和应对方式。
                </p>
              </div>
            </div>
          </div>
          ...
          {/* 评估工具 */}
          <div className="p-3 bg-green-50/40 dark:bg-green-950/20 border border-green-100/50 dark:border-green-800/40 rounded-xl space-y-1.5">
          ...
          {/* 安全红线规范 */}
          <div className="p-3 bg-amber-50/40 dark:bg-amber-950/20 border border-amber-100/50 dark:border-amber-800/40 rounded-xl space-y-1.5">
